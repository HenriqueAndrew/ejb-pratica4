 ...
 * generated in the com.henriqueandrewsilva.cli package. 
...
public class ObjectFactory {
    ...
    private final static QName _SomarResponse_QNAME = new QName("http://provider.henriqueandrewsilva.com/", "somarResponse");
    private final static QName _Somar_QNAME = new QName("http://provider.henriqueandrewsilva.com/", "somar");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.henriqueandrewsilva.cli
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://provider.henriqueandrewsilva.com/", name = "somarResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://provider.henriqueandrewsilva.com/", name = "somar")
